<h2><a href="https://www.geeksforgeeks.org/problems/count-pairs-with-given-sum5022/1">Pairs with 0 Sum</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);" bis_skin_checked="1"><p><span style="font-size: 14pt;">Given an integer array&nbsp;<strong>arr</strong>, return all the&nbsp;unique<strong>&nbsp;</strong>pairs [arr[i], arr[j]] such that&nbsp;i != j and arr[i] + arr[j] == 0.</span></p>
